...
public class ZoomableImageView extends AppCompatImageView {
    ...
    private final static float ANIMATION_ZOOM_PARAMETER = 2f; //default 1.3f
    private static final int SWIPE_MIN_DISTANCE = 100;
    private static final int SWIPE_THRESHOLD_VELOCITY = 800;
    private static final int MIN_DELAY_BETWEEN_DOUBLE_TAP = 65;
    private static final int MAX_DELAY_BETWEEN_DOUBLE_TAP = 140;
    ...
    private PointF last = new PointF(); //holds two float coordinates
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap( MotionEvent e ) {
            long diffTime = System.currentTimeMillis() - firstTimeStamp;
            ...
            if (zoomByDoubleTap && countZoomsByDoubleTap == 0 && saveScale == 1f && isZoomAvailable) {
                ...
                countZoomsByDoubleTap++;
                    ...
                    ValueAnimator zoomAnimation = ValueAnimator.ofFloat(saveScale, 1f);
                    zoomAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                        public void onAnimationUpdate(ValueAnimator valueAnimator) {
                            float value = (Float) valueAnimator.getAnimatedValue();
